...
In L<Mojolicious> we consider web applications as simple frontends for existing
...
In L<Mojolicious> we take testing very seriously and try to make it a pleasant
experience.
...
limit, depending on the browser.

=head2 Final prototype

A final C<myapp.pl> prototype that passes all of the tests above could
look like this.
